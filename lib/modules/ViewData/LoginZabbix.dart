          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
              ...
              height: 100,
                ...
                defualtTextField(controller: ZabbixUrlController, type: TextInputType.text,
                    validate: (value){
                    ...
                    onTap: (){},
                    lable: 'ZabbixUrl', prefix:Icons.link),
                SizedBox(
                  height: 20,
                ),
                defualtTextField(controller: UserNameController, type: TextInputType.text,
                    validate: (value){
                      if(value != null && value.isEmpty){
                    ...
                    onTap: (){},
                    lable: 'UserName', prefix:Icons.account_circle_outlined),
                SizedBox(
                  height: 20,
                ),
                ...
                defualtButton(
                   function: (){
                     if(formKey.currentState!.validate()){
                      ...
                      if((UserNameController.text=="Admin" && UserNameController.text.isNotEmpty ) && (passController.text=="zabbix" && passController.text.isNotEmpty )){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => NavBarZabbix(key)),
                        );
                     }
                      else{
